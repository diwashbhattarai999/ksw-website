...
interface PlanItem {
 ...
 const  SeoPackageCard: React.FC<cardProps> =  ({heading,btn, initial, setup, technical, offPageSEOContent, localSEOContent,monthlyReportContent})=>  {
  ...
  return (
    <>
     <div>
        <div className='w-[80%] m-auto md:w-[40vw] lg:w-[20vw] mt-4    h-fit pt-1 rounded-md shadow-xl text-black'>
        ...
        <div className='mt-8 pl-2 pb-4'>
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>Initail website Analysis</h3>
            <ul className='pl-3 '>
              {
                initial.map((item, index)=>{
                   return (
                      <div className='flex  gap-2  '>
                        {item.isActive ? <img src="/SeoPackage/check.png" alt="" className='w-3 h-3 relative top-2' />: <img src="/SeoPackage/cross.png" alt="" className='w-3 h-3 relative top-2'  />}
                        <li>{item.text}</li>
                      </div>
                   )
                })
            ...
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>On page setup</h3>
            <ul className='pl-3'>
              {
            ...
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>Technical Seo</h3>
            <ul className='pl-3'>
              {
            ...
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>Off Page Seo</h3>
            <ul className='pl-3'>
              {
            ...
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>Local seo</h3>
            <ul className='pl-3'>
              {
            ...
            <h3 className='font-bold text-[0.8rem] sm:text-[1rem] mt-1 mb-1'>Monthly Report</h3>
            <ul className='pl-3'>
              {
